    ...
    def live_method(player: Player, data):
        ...
        if data["first"] == 1:
            ...
            if data["select_type"] == "A":
                player.Decision_MPL_0 = (
                    mpl_list[: int(data["position_num"]) - 1]
                    + "A"
                    + mpl_list[int(data["position_num"]) :]
                )
            else:
                player.Decision_MPL_0 = (
                    mpl_list[: int(data["position_num"]) - 1]
            ...
            player.num_A_risk = player.Decision_MPL_0.count("A")
            player.num_B_risk = player.Decision_MPL_0.count("B")
            player.multiple_switch_MPL0 = (
                "B" in player.Decision_MPL_0[: player.num_A_risk]
            )
...
class Decision1(Page):
    ...
    def live_method(player: Player, data):
        if data["first"] == 1:
            ...
            player.num_A_MPL_1 = player.Decision_MPL_1.count("A")
            player.num_B_MPL_1 = player.Decision_MPL_1.count("B")
            player.multiple_switch_MPL1 = (
                "B" in player.Decision_MPL_1[: player.num_A_MPL_1]
            )
...
class Decision2(Page):
    ...
    def live_method(player: Player, data):
        if data["first"] == 1:
            ...
            if data["select_type"] == "A":
                player.Decision_MPL_2 = (
                    mpl_list2[: int(data["position_num"]) - 1]
                    + "A"
                    + mpl_list2[int(data["position_num"]) :]
                )
            else:
                player.Decision_MPL_2 = (
                    mpl_list2[: int(data["position_num"]) - 1]
            ...
            player.num_A_MPL_2 = player.Decision_MPL_2.count("A")
            player.num_B_MPL_2 = player.Decision_MPL_2.count("B")
            player.multiple_switch_MPL2 = (
                "B" in player.Decision_MPL_2[: player.num_A_MPL_2]
            )
