...
class Player(BasePlayer):
    q1 = models.StringField(
        widget=widgets.RadioSelect, verbose_name="", choices=C.CHOICE_LIST_SENTE[0:2]
    )
    q1_why = models.LongStringField(label="""なぜその選択をしましたか？""")

    q2 = models.StringField(
        widget=widgets.RadioSelect, verbose_name="", choices=C.CHOICE_LIST_SENTE[2:4]
    )
    q2_why = models.LongStringField(label="""なぜその選択をしましたか？""")

    q3 = models.StringField(
        widget=widgets.RadioSelect, verbose_name="", choices=C.CHOICE_LIST_SENTE[4:6]
    )
    q3_why = models.LongStringField(label="""なぜその選択をしましたか？""")
